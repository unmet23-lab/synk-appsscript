...
function 상담_인계알림본_(세션, 사용자말, 사유, 플랫폼) {
  ...
  // [vNEXT] 역번역이 «검증 폐기»(옛 글자)로 비었으면 이름으로 알린다 — 일시 오류의 얼굴로 두면
...
/* [vNEXT] 역번역 처분 — null(일시 오류)과 «검증 폐기»(옛 글자)를 값의 모양으로 가른다(리뷰 P2-②).
...
/* [vNEXT] 확인 화면 본문 — 순수 조립(리뷰 P2-②). 🔑 발송 링크는 역번역이 «있을 때만» 실린다.
