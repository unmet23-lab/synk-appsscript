...
function 상담AI_점검() {
  ...
  const 시험 = [
     ...
     *     열두 달 과정을 마치고 «첫 시험»에서 4급 · 5급은 재량 · 못 닿으면 앱 온라인 수업으로 «취득까지»
     *     무료 케어(그리고 그 케어는 «배상»이 아니라 처음부터 상품에 든 것으로 말한다).
     *     🔴 [09-07 유호 확정 「Ⓑ+Ⓓ 로 가자」] 대조 기준이 «1년 안에»에서 위 문장으로 바뀌었다 —
     *     봇이 옛 판(「1년 안에 4급」)으로 답하면 그것도 어긋남이다(재료 = docs/출국전_4급_재료_v1.md).
