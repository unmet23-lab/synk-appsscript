...
if (로고표준형) {
  /* 라이트 지면(Paper 바탕)용 + 다크 지면용 한 벌.
     🔑 09-07 에 다크가 필요해졌다 — 첫 게시물 티저가 «어두운 펠트 천» 위에 서기 때문이다.
     옛 주석은 「다크판은 이 영상에 쓸 자리가 없다」였는데, 그 전제가 그날 깨졌다. */
...
/* 09-10 승인본: SYNK는 무실땀 펠트, LAB 사업명은 고유색·스티치를 유지한 완성 조합. */
복사(path.join(저장소, 'docs', '홍보물', '마케팅실행_20260909', '브랜드킷', '배치용', 'SYNK-LAB-Ink.png'), '릴10편/로고.png');
