...
const CONSULT_CONSENT_HELP = '수집: 이 설문의 응답(연락처·보호자 정보·학습 배경·목표·취향) / '
  + '용도: 상담·반 배정·학습 개인화(응원 문장·퀴즈·성장 리포트의 소재)·학원 운영 통계, 그리고 '
...
const VOICE_CONSENT_HELP = '※ 필수 문항입니다 — SYNK LAB의 말하기 수업은 여러분의 목소리로 배워서 여러분을 고쳐 주는 방식입니다. '
  ...
  + '동의를 철회하시면 그 시점에 보관 중인 녹음을 모두 삭제합니다. ' + CONSENT_IRREVERSIBLE + ' / '
  + '그 밖의 제3자 제공 없음 · 동의 철회는 언제든 학원으로 연락 주시면 즉시 중단하고 기존 녹음도 삭제합니다.';
...
const CONSENT_HELP_A_MN = 'Цуглуулах зүйл: энэ судалгааны хариулт (холбоо барих мэдээлэл, асран хамгаалагчийн мэдээлэл, суралцах туршлага, зорилго, сонирхол) / '
  + 'Хэрэглэх зорилго: зөвлөгөө, анги хуваарилалт, хувийн сургалтын тохируулга (урам зоригийн мессеж, шалгалт, өсөлтийн тайлангийн эх материал), сургуулийн үйл ажиллагааны статистик, '
...
const CONSENT_HELP_B_MN = '※ Заавал бөглөх асуулт — SYNK LAB-ын ярианы хичээл нь таны дуу хоолойгоор сурч, таныг залруулдаг арга юм. '
  ...
  + 'мөн SYNK LAB болон түүний холбоотой, залгамжлагч байгууллагын бүтээх солонгос хэл сурах үйлчилгээ (апп, AI сургалтын хэрэгсэл)-ийг хөгжүүлэх, сайжруулах / '
  + 'Сургалтын үйлчилгээ хөгжүүлэхэд ашиглахдаа нэр, холбоо барих мэдээллийг устгасан хэлбэрээр л ашиглана / '
  + 'Хадгалах хугацаа: хугацааны хязгааргүй хадгална — олон жилийн турш «анхны дуу хоолой vs өнөөдрийн дуу хоолой» гэсэн өсөлтийн бүртгэл үлдээхийн тулд. '
  + 'Зөвшөөрлөө цуцалбал тухайн үед хадгалагдаж буй бүх бичлэгийг устгана. '
  + 'Гэхдээ AI-г сургахад аль хэдийн ашигласан хэсгийг буцаах боломжгүй — сурсан загвараас нэг хүний дуу хоолойг салгаж авах арга байхгүй. Цуцалсны дараа ашиглахгүй / '
  + 'Бусад гуравдагч этгээдэд дамжуулахгүй · '
  + 'Зөвшөөрлөө цуцлах бол хэдийд ч сургуульд хандвал шууд зогсоож, өмнөх бичлэгүүдийг устгана.';
...
/* [v9.138] 동의 문구 판(版) 단일 소스 — 구 구조는 'v18.6'이 5곳(마이그레이션 선언·워치독·노션 게이트·
