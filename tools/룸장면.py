...
def 로고고리세우기():
    ...
    실꼬임 = 0.30                                    # 진폭 = 굵기보다 조금 커야 두 가닥이 안 파고든다
    ...
    고리가닥("고리잉크", (-1.20, -0.90), 2.00, 0.275, 위각=78.3, 아래각=-4.5,
            진폭=실꼬임, 재질=잉크천)
    고리가닥("고리코랄", (1.20, 0.90), 2.00, 0.275, 위각=-101.7, 아래각=175.5,
            진폭=실꼬임, 재질=코랄천)
