 ...
 *
 * 이 도구는 굴절·분산·코스틱이 필요한 기존 부품을 Blender로 렌더하는 통로다.
 *   제작 코드와 원본·출력 경로를 함께 보존해 다음 작업에서 재사용한다.
 *   다른 결과물의 사진·생성·3D·CSS 사용을 일괄 제한하지 않는다.
 *   현재 재질과 움직임 선택은 DESIGN.md·docs/Loom_실시간장면_표현기준.md를 따른다.
 *
 * 사용:
