...
const 부품표 = [
  ...
  { 이름: '합주',     부품: '합주',   봉입: '파편', 두층: true, 해상도: 1200, 샘플: 420,
    쓰임: '표지·히어로 장면(재질 셋이 서로를 안다)' },
  { 이름: '로고꺾쇠', 부품: '로고꺾쇠', 봉입: '없음', 펠트색: 'Coral', 두층: true, 해상도: 1100, 샘플: 360,
    쓰임: '로고 확정 08-21 — B2 워드마크의 신호 꺾쇠(펠트 실물)' },
  { 이름: '로고배지', 부품: '로고배지', 봉입: '없음', 두층: true, 해상도: 1200, 샘플: 400,
    쓰임: '로고 확정 08-21 — 앱 아이콘 몽글 배지(꺾쇠=입 옆모습)' },
];
...
function 굽기(칸, 옵션 = {}) {
  ...
  if (hdri && fs.existsSync(hdri)) args.push('--hdri', hdri, '--hdri세기', String(옵션.hdri세기 || 0.55));
