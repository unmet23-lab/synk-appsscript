...
const 갈래들 = [
  ...
  { 키: '사람', 이름: '사람 · NPC', 설명: '학원에서 만나는 사람들. 강사·가이드·마린·NPC.',
    /* 🔴 09-05 밤 — `마린_후보`(124장 1.4GB)를 걷었다. 마린 생김새가 그날 확정되고 정본 16컷이
       섰으므로(`docs/캐릭터/정본_4K/마린_*.png`) 후보는 «대체된 옛 판»이다.
       유호 확정 09-05 「대체된 최신화된것들이 있으면 예전꺼 다 버려야지」.
       ⚠ `tools/마린굽기.js` 는 그대로 둔다 — 다시 고를 일이 생기면 그 도구가 폴더를 새로 만든다. */
    뿌리: ['docs/캐릭터/NPC공방_0824', 'docs/캐릭터/강사공방_0823', 'docs/캐릭터/가이드_아바타', 'docs/캐릭터/마린공방_0826', 'docs/캐릭터/마린공방_0827'] },
