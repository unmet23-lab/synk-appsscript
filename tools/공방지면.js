...
const 갈래들 = [
  ...
  { 키: '마스코트', 이름: '마스코트', 설명: '몽글(펠트코랄)과 까몽. 학생이 앱에서 만나는 얼굴.',
    /* 🔑 09-05 — 정본이 «정본_4K» 한 폴더로 합쳐졌다(몽글 6 · 까몽 10 · 마린 11).
       옛 셋은 아직 안 지웠으므로 목록에 남긴다 — 지우는 날 이 줄에서 함께 걷는다. */
    뿌리: ['docs/캐릭터/정본_4K', 'docs/캐릭터/펠트코랄_0815', 'docs/캐릭터/까몽공방_0901', 'docs/캐릭터/친구공방_0825', 'docs/캐릭터/몽글'] },
  { 키: '사람', 이름: '사람 · NPC', 설명: '학원에서 만나는 사람들. 강사·가이드·마린·NPC.',
    뿌리: ['docs/캐릭터/NPC공방_0824', 'docs/캐릭터/강사공방_0823', 'docs/캐릭터/가이드_아바타', 'docs/캐릭터/마린공방_0826', 'docs/캐릭터/마린공방_0827', 'docs/캐릭터/마린_후보'] },
