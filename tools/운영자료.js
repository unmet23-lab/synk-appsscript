...
/** 갈래 — 유호님이 여는 화면은 이 셋뿐이다(유호 확정 2026-08-13 「이렇게 3개의 폴더만 있었으면」).
 *
 ...
 * 키(철학·정본·운영)는 명령줄에서 쓰는 짧은 이름이고, 값은 화면에 보이는 폴더 이름이다.
 * 앞 숫자는 탐색기 정렬을 유호님이 말한 순서(철학 → 정본 → 운영)로 고정한다. */
