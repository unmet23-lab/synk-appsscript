...
def 화면단추(부, cx, cz, 깊이, 꿰맴, 지금=False, r=0.085):
...
def 리포트판():
    ...
    카드z = 1.32
    카드 = 베개몸((1.21, 0.09, 0.70), 위치=(0, 0.5, 카드z), 크리스=0.80, 레벨=4)
    카드.data.materials.append(직물결(매끈재질('리포트카드', 색['Ink'], 거칠기=0.95), 규모=180.0, 세기=0.055))
    키제외.append(카드)
    칸들['이번달'] = 카드
    러닝스티치(둥근사각걷기(1.21 - 0.09, 0.70 - 0.09, 0.10, 0.115), 0.40, (0, 카드z),
             매끈재질('카드실', 색['Deep Wool'], 거칠기=0.78), 0.040, 0.0085, 손, 흔들=0.004, 각흔들=4.0)
...
def 부모소식판():
    ...
    카드z = 1.32
    카드 = 베개몸((1.21, 0.09, 0.70), 위치=(0, 0.5, 카드z), 크리스=0.80, 레벨=4)
    카드.data.materials.append(직물결(매끈재질('공지카드', 색['Ink'], 거칠기=0.95), 규모=180.0, 세기=0.055))
    키제외.append(카드)
    칸들['새공지'] = 카드
    러닝스티치(둥근사각걷기(1.21 - 0.09, 0.70 - 0.09, 0.10, 0.115), 0.40, (0, 카드z),
             매끈재질('카드실', 색['Deep Wool'], 거칠기=0.78), 0.040, 0.0085, 손, 흔들=0.004, 각흔들=4.0)
