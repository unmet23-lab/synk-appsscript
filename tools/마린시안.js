...
<p class="듦"><b>스파르타 선생님</b>(유호 08-28) — 얼굴은 <b>정면</b>(z50 · 스윕 눈 판정), 투구 위 <b>가로 볏</b>
...
<div class="짝">${우주복들.map((r) => 칸(r, r.이름.includes('몽글') ? '우주복 몽글 · 스파르타 선생님(볏·방패)' : '우주복 까몽 · 먹 헬멧 + 코랄 볏')).join('')}</div>` : ''}
