...
const 규격들 = {
  유튜브:   { W: 2560, H: 1440, 안전W: 1235, 안전H: 338, 배: 1,    올림: 0,  몽글폭: 560, 몽글우: 186, 이음비: 0.875 },
  페북커버: { W: 1640, H: 596,  안전W: 1050, 안전H: 380, 배: 0.64, 올림: 0,  몽글폭: 300, 몽글우: 74, 이음비: 0.82 },
};
let { W, H, 안전W, 안전H, 배, 올림, 몽글폭, 몽글우, 이음비 } = 규격들.유튜브;
/** 안 하나를 굽기 직전에 그 안의 규격으로 갈아 끼운다. 안을 하나씩 굽는 도구라 안전하다. */
function 규격적용(안) {
  ({ W, H, 안전W, 안전H, 배, 올림, 몽글폭, 몽글우, 이음비 } = 규격들[(안들[안] || {}).규격 || '유튜브']);
}
...
<style>
  ...
  .안전선{position:absolute;left:50%;top:50%;transform:translate(-50%,calc(-50% - ${올림}px));z-index:9;
