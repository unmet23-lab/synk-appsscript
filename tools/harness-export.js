...
| 파일 | 용도 |
|---|---|
| \`AGENTS.md\` | GPT Codex의 총괄·실행 역할 |
| \`CLAUDE.md\` | Claude의 판단·설계·검토 역할 |
| \`GEMINI.md\` | Gemini/Antigravity의 자료·멀티모달 역할 |
...
원래 저장소에서 작업할 때는 해당 모델의 지침과 공통 원칙을 직접 읽습니다. 다른 환경에 전달할 때는 목적에 맞는 지침과 관련 원문만 사용하고, 실행에 필요한 저장소 경로와 자산이 그 환경에 있는지 확인합니다.
