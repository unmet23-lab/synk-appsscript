 ...
 *   ⇒ 형식을 바꿨다(「장면형」 — 문제가 먼저 서고 표현이 해결로 들어온다 · 30초 → 22~24초).
 *   ⚠ 겨냥은 18초였는데 «읽는 시간 하한»이 그만큼 늘렸다 — 몽골어를 다 실으면 못 줄인다.
 *     그 맞바꿈(예문을 줄일까·쓰임 칸을 뺄까·몽골어를 표현 칸에만 둘까)은 유호님 판정 자리라 지면이 묻는다.
 *
...
<header class="표지">
  ...
  <div>
    ...
    <b>${새09잼.초}초 여덟 칸</b>이 됐습니다(겨냥은 18초였습니다 · §05 에 왜 늘었는지 적었습니다).</p>
