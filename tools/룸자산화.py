...
#   🔴 왜 이제야 드나 — 09-08 실측: 구운 이름 1,028가지 중 지면이 부르는 것이 «약 10가지»였다.
#      「큰 그림 2차」 묶음은 계획서에 쓰는 곳이 **「발표물 표지 · 소개서 절 머리」**라고 적혀 있는데
#      한 자리도 안 실려 있었다. 구워 놓고 안 쓴 자리가 정확히 여기다.
#   🔑 고르는 자 = «지면의 절과 짝이 맞나». 예쁜 것을 고르지 않고, 그 절이 말하는 것을 그림이
#      대신 말해 주는 것만 고른다(나침반 = 나침반 3문항 · 졸업모 = TOPIK 4급 · 여권 = 유학생).
#      짝이 없는 그림은 장식이고, 장식은 지면 무게만 늘린다.
#   ⚠ 크기 256 = 지면에서 ~128px 로 쓰고 레티나 두 배. 640(표지 장면)은 절 머리에 과하다.
#   ⚠ 열 장이 늘면 지면 무게도 는다 — 실측치는 이 도구가 마지막 줄에 찍는다.
#   ⚠ 키는 «파일 이름»이다 — 이 도구의 `원본고르기` 가 키에 확장자를 붙여 구움 폴더를 찾는다.
#      역할 이름을 키로 쓰고 싶어도 안 된다(그러면 원본을 못 찾고 조용히 「빈 것」이 된다).
#      역할은 `쓰임` 이 적는다.
규격.update({
    "공방_나침반":       {"크기": 256, "쓰임": "절 머리 — 나침반 3문항·방향 잡기"},
    "공방_졸업모":       {"크기": 256, "쓰임": "절 머리 — TOPIK 4급·수료·졸업 요건"},
    "공방_펠트지구본":   {"크기": 256, "쓰임": "절 머리 — 몽골↔한국·해외"},
    "공방_펠트여권비자": {"크기": 256, "쓰임": "절 머리 — 유학생·비자·입국"},
    "공방_펠트계단성장": {"크기": 256, "쓰임": "절 머리 — 성장 단계·로드맵"},
    "공방_공책과연필":   {"크기": 256, "쓰임": "절 머리 — 숙제·교재·쓰기"},
    "공방_편지봉투":     {"크기": 256, "쓰임": "절 머리 — 상담·안내·연락"},
    "공방_탁상시계":     {"크기": 256, "쓰임": "절 머리 — 수업 시간·주당 시수"},
    "공방_지도":         {"크기": 256, "쓰임": "절 머리 — 커리큘럼 로드맵·차례"},
    "공방_펠트책한권":   {"크기": 256, "쓰임": "절 머리 — 교재·읽기"},
