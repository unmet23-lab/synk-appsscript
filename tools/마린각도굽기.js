...
function main() {
  ...
  if (!인자['지면만']) {
    ...
    (굽기(BL, 길.primey, 'primey_해석_몽글', '', '우리색', [...미니, '돌리기=z30,x-8', '재질=펠트',
      '갑옷=Coral', '갑옷배율=0.92', '눈색=Butter', '눈발광=1.6', '눈띠=0.868,0.896', '눈폭=0.50'])
      ? 난것++ : 죽은것++);
    (굽기(BL, 길.primey, 'primey_해석_까몽', '', '우리색', [...미니, '돌리기=z30,x-8', '재질=펠트',
      '갑옷=Ink', '갑옷배율=1.0', '눈색=Coral Rim', '눈발광=2.2', '눈띠=0.868,0.896', '눈폭=0.50',
      '빛배=1.35', '받침=Oat']) ? 난것++ : 죽은것++);
