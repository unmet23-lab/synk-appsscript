...
root=Path('C:/Users/q1212/.codex/visualizations/2026/09/11/01a08f0d-d3c5-7c41-9c85-d69384fa2412/IP_디딤돌_준비/미팅완성본/발전구현_0.5_20260912')
reader=PdfReader(root/'SYNK_CORE_등록준비_발전구현_0.5.pdf')
...
result={'pages':11,'fontsEmbedded':all(f['embedded'] for f in fonts),'fontOccurrences':len(fonts),'renderedPages':len(pages)}
