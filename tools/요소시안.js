...
const 설명 = {
  ...
  구분선: ['<b>talk 앱 반입 1보를 막고 있던 «단 한 장»</b>이다 — 변환분 28장에 관문 넷을 실제로 걸어 보니 <b>다 지나는 것이 0장</b>이었다. 지금 앱의 그 자리는 1px 실금이다.',
        '<b>띠가 없다</b> — 형제 형태 「스티치」는 코랄 펠트 띠 <i>위에</i> 땀을 놓지만, 앱의 구분선은 화면 바탕 위로 실만 지나가야 한다. 띠를 함께 구우면 유채가 하나 늘어 그 화면의 신호가 둘이 되고, 이 앱에서 <b>「코랄 = 지금 녹음 중」</b>이라는 낱말이 흐려진다.',
        '실은 <code>Stitch</code>(#F0E3C8) — 킷 실땀 정본이고 크로마 0.157 로 섬유 문턱(0.16) <b>안</b>이라 무채로 선다. 양 끝은 <b>프레임 밖</b>에 뒀다: 끝이 보이면 「짧은 실 한 도막」이 되어 카드 폭마다 다시 구워야 한다.'],
