  ...
  },
  {
    ...
    화면들: [
      ...
      { 이름: '학생', 길: 캐('강사공방_0823', '강사학생판_v1.png'),
        뜻: '칭찬 4태그 — <b>개수 4는 불변</b>이다(오늘의 도전·성장·크루의 눈의 재료라 하나만 늘어도 두 곳이 흔들린다).' },
      { 이름: '검수 🔴', 길: 캐('강사공방_0823', '검수판_v1.png'),
        뜻: '<b>이 앱에서 가장 중요한 화면.</b> Glide 가 폐기되면 강사 판정의 유일한 입구가 죽는다(폐기 확정 08-05 · 실물은 파일럿 게이트까지 낙하산 존치). 판정 셋은 퀴즈의 보기 알약과 같은 부품이다.' },
