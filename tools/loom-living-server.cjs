...
const server=http.createServer((req,res)=>{
  ...
  if(process.env.LOOM_CAPTURE==='1'&&req.method==='PUT'&&req.url.startsWith('/__qa/')){
    const name=req.url.slice(6),allowed=new Set(['preview.webm','desktop.png','mobile.png','blink.png','turn.png','report.json','dialogue-desktop.png','dialogue-mobile.png','dialogue.json','wind.json','grass-contour.json','grass-contour.png']);
