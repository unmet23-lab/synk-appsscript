 ...
 *
 * 통로: node tools/부품형태시안.js   (밤 사슬 ⑥-b · 굽기 뒤에 돈다)
 */
...
const 판들 = [
  {
    ...
    후보: [
      { 이름: '매듭(현행 형태·같은 자로 다시)', uri: 렌더('형태후보', '후보_불릿_매듭') },
      { 이름: '매듭점(신규 — 세잎 매듭)', uri: 렌더('부품형태', 'A1_매듭점') },
      { 이름: '프렌치노트(신규 — 감아 만든 점)', uri: 렌더('부품형태', 'A2_프렌치노트') },
    ],
  ...
  },
  {
    ...
    후보: [
      { 이름: '라벨태그(현행 형태)', uri: 렌더('형태후보', '후보_번호_라벨태그') },
      { 이름: '단추(현행 형태)', uri: 렌더('형태후보', '후보_번호_단추') },
      { 이름: '단추숫자 01(신규 · 자수)', uri: 렌더('부품형태', 'B1_단추숫자_01') },
      { 이름: '단추숫자 07(신규 · 자수)', uri: 렌더('부품형태', 'B1_단추숫자_07') },
      { 이름: '라벨숫자 01(신규 · 자수)', uri: 렌더('부품형태', 'B2_라벨숫자_01') },
      { 이름: '라벨숫자 07(신규 · 자수)', uri: 렌더('부품형태', 'B2_라벨숫자_07') },
    ],
  ...
  },
  {
    ...
    후보: [{ 이름: '땀점(신규 — 러닝 스티치 한 땀)', uri: 렌더('부품형태', 'C_땀점') }],
  ...
  },
  {
    ...
    현행: { 이름: '칩', uri: 현행('칩') },
    후보: [
      { 이름: '직조라벨(통짜 · 현행 형태)', uri: 렌더('형태후보', '후보_태그_직조라벨') },
    ],
    세겹: {
  ...
  },
  {
    ...
    후보: [
      { 이름: '와펜(현행 형태)', uri: 렌더('형태후보', '후보_히어로_와펜') },
      { 이름: '폼폼(현행 형태)', uri: 렌더('형태후보', '후보_히어로_폼폼') },
      { 이름: '와펜숫자 16(신규 · 자수)', uri: 렌더('부품형태', 'E1_와펜숫자') },
      { 이름: '폼폼숫자 16(신규 · 자수)', uri: 렌더('부품형태', 'E2_폼폼숫자') },
      { 이름: '매듭숫자 16(신규 · 자수)', uri: 렌더('부품형태', 'E3_매듭숫자') },
    ],
