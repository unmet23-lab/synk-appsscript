...
<br><span class="메타">굽기 자 — 다섯 다 700px·96샘플·CPU 로 맞췄다(08-29). 08-26 판 셋은 GPU 조율판(40샘플·장당 1.1분)이라
새 둘보다 털이 거칠었고, <b>거친 셋과 고운 둘을 나란히 두면 눈이 아니라 «또렷함»으로 고르시게 된다</b> —
그래서 셋을 새 자로 다시 구웠다(장당 13.4분 · CPU). 승격 재굽기(1024px)도 같은 자다.</span></div>
