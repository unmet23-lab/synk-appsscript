...
function main() {
  ...
  const 급표 = {
    요구: ['필수', '성격 v2 가 요구하는 감정 — 허세·겁·들킴(정본 §10:430)'],
    목록: ['덤', '정본 표정 목록엔 있으나 성격이 요구하진 않는다(§10:439)'],
    밖: ['덤', 'v1 시절 시안 — 정본 표정 목록에 없다'],
  };
  const 급딱지 = (이름) => {
    const g = 급표[급[이름]];
...
<div class="유리 알림 듦"><b>이 줄은 «아직 정본이 아니다».</b> 700px 라 위 다섯(1024px)과 <b>크기가 다르다</b> —
