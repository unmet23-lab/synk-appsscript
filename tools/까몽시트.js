...
const 표정들 = [
  ...
  ['눈감음', '감은 눈 ⌒⌒', '작은 땀 다섯을 얕은 호 위에 늘어놓은 «수놓은 선» · 눈동자와 같은 Meadow 초록실. 큰 땀 셋이던 옛 판은 눈웃음과 같게 읽혔다.'],
  ['눈웃음', '웃는 눈 ∧∧', '가지 둘이 ±50° 로 꼭짓점에서 만난다(Meadow 초록실). 각을 세워야 «감은 눈»과 갈린다.'],
...
<ol class="듦">
  ...
  <li><b>누끼판</b> — 아직 없다(<code>투명=1</code>). 앱 지면에 얹는 단계의 재료이고, 두 패스(몸+접지)라 시간이 2배다.
      이 다섯 장 판정이 선 뒤 다음 밤에 굽는다.</li>
</ol>
