#!/usr/bin/env node
/**
 * 네온시안 — A실 후면 벽 네온사인 «두 안»을 나란히 굽는다 (2026-08-30 · 08-31 오독 수리)
 *
...
<div class="폭">
  ...
  <p class="머리설명">
    A실 <b>후면 벽</b>(메인 촬영 배경)에 걸릴 SYNK 네온입니다.
    갈리는 것은 <b>네온이 «한 색»인가 «두 색»인가</b> 하나입니다.
  </p>
  <p class="머리설명">
    급소는 <b>조명이 켜졌을 때와 꺼졌을 때가 갈린다</b>는 것이라 네 장면을 한 화면에 뒀습니다.
    윗줄이 <b>촬영 모드</b>(실내등 5000K 켬), 아랫줄이 <b>무대 모드</b>(실내등 끔)입니다.
  </p>

  <p class="고정">
    🔒 <b>벽은 이 판정의 변수가 아닙니다</b> — 후면 벽은 이미
    <code><span class="견본" style="background:${INK_DEEP}"></span>Ink Deep ${INK_DEEP}</code>
    <b>흡음 패널(펠트 면)</b>로 정해져 있습니다(정본 v5 §4 「딥 블랙 또는 다크 그레이 · 흡음 패널」 ·
    공간설계 §6 표 D). <b>기존 벽에 무엇이 칠해져 있든 펠트 패널이 덮습니다</b> — 매물이 아직
    안 정해진 것은 이 자리의 차단자가 아닙니다.
  </p>
  ...
  <div class="판정">
    <div class="칸">
      <h3>㉠ 코랄 + 크림 <code><span class="견본" style="background:${CORAL}"></span>${CORAL}</code> <code><span class="견본" style="background:${PAPER}"></span>${PAPER}</code></h3>
      <ul>
    ...
    <div class="칸">
      <h3>㉡ 코랄 단색 <code><span class="견본" style="background:${CORAL}"></span>${CORAL}</code></h3>
      <ul>
  ...
  ${안내('㉠ 의 «두 색을 어떻게 나누는가»는 정본에 없습니다',
    'v4.1 은 「오렌지 + 웜크림」으로 <b>주·보조만</b> 정했을 뿐, 어디에 무엇을 쓰는지는 안 적었습니다. ' +
    '여기서는 가장 흔한 꼴 — <b>글자 = 코랄(주) · 아웃라인 = 크림(보조)</b> — 으로 그렸습니다. ' +
    '<b>뒤집을 수도 있습니다</b>(글자 크림 · 아웃라인 코랄). 유호님이 ㉠ 을 고르시면 그 나눔도 함께 여쭙겠습니다.')}
  ...
  ${안내('고르시면 어디가 움직이나',
    ...
    '곁들여 정본 문면의 그 두 줄도 «벽으로 안 읽히게» 다듬겠습니다 — 오늘 제가 걸린 자리입니다.')}
  ...
  <p style="margin-top:34px; font-size:12.5px; color:#7d736c; font-family:var(--모노); letter-spacing:.02em">
    node tools/네온시안.js · 정본 = 07_SYNK_메인룸_인테리어.txt v5 §4 · 2026-08-30 (08-31 정정)
  </p>
</div>
</body>
</html>
