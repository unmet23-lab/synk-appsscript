...
const 후보들 = [
  {
    코드: '㉠', 이름: '양모 밤 ✅확정', 한줄: '펠트 세계에 불을 끈 판 — 낮의 글자가 밤의 면이 된다 · 유호님 확정 2026-08-20(조항 ⓚ)',
...
<div class="끝">
<h2>✅ 유호님 확정 (2026-08-20) — ㉠ 양모 밤</h2>
<p style="margin:0 0 12px"><b>확정·착지 완료.</b> 토큰 정본에 조항 ⓚ 로 섰고(킷 41→42 · <code>Ink Deep #080605</code> 신설),
다크 시맨틱이 8칸 → 18칸으로 재배선됐다. 아래는 그 판정의 근거 기록이다.</p>
<ol>
