 ...
 *
 * 🔑 2026-08-20 **이사** — 원래 `tools/작업본소유자.js(⚠삭제됨 39019553 2026-08-20 — 지금 없다)` 에 살았다. 보드 층을 걷을 때 그 도구에서
...
function 진입() {
   ...
   * 🔑 목록은 눈으로 정하지 않았다 — `tests/lib/도구인자.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다)` 의 `CLI도구들()` 로 재서 셋이고,
   *   `tests/도구인자게이트.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다)` ④ 가 「자기 낱말 전량을 선언이 덮는가」를 매번 다시 센다.
