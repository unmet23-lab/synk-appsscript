 ...
 *   ⓪까몽 5 → ①화면 14(옛 AgX 자)+덧씌움 → ②NPC 몸색 재료 8 → ③NPC 20 → ④시트
 *     → ⑤라이브러리 52 → ⑥검사
 *   ⓪ 까몽 5장은 **맨 앞**이다(요소 세션 합의 08-25 `c4c56d91`) — 중간에 끼우면 ⑥검사가
 ...
 *   ⏱ 까몽 5 ≈1시간(GPU 생존)~3.5시간(되물림) · 화면 ≈1.5시간(미실측) · NPC 28 = 6.2시간(실측
 ...
 */
단계('⓪ 까몽 5장 — 1024px · 샘플 96 · 새 털 정본', () => 노드('까몽굽기.js', []));
