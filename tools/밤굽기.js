 ...
 *   ⓪까몽 확정 3 → ⓪b까몽 새 감정 시안 3 → ①화면 14(옛 AgX 자)+덧씌움 → ②NPC 몸색 재료 8 → ③NPC 20 → ④시트
 *     → ⑤라이브러리 52 → ⑥검사
 *   ⓪ 까몽은 **맨 앞**이다(요소 세션 합의 08-25 `c4c56d91`) — 중간에 끼우면 ⑥검사가
 *      기준 시각으로 셀 때 갈래를 오독한다. 3~4시간을 쓰지만 그중 유일하게 «세트가 아직 없는» 자리다.
 ...
 */
단계('⓪ 까몽 확정 3장 — 1024px · 샘플 96 · 새 실색·새 표정·슬림 꼬리', () => 노드('까몽굽기.js', []));
