 ...
 *
 * ■ 색은 이 파일이 모른다 — 정본 = 요소굽기.py 기본값 (현행 확정은 결정.md 가 쥔다)
 *   이 도구는 색 인자를 안 넘긴다. 그래서 자를 바꾸는 날 «여기»는 고칠 게 없다 — 08-24 에 두 번
 *   실증됐다(PBR 중립 222장 → 전면 반려 → AgX Punchy 확정, 이 파일은 한 줄도 안 바뀜).
