...
/* 🔴 Ash Wool 은 Paper 위에서 3.41대1 이라 본문 크기로는 안 읽힌다(09-03 접근성 실측).
   같은 계열의 짙은 판 Deep Wool 은 7.45대1 — 결은 그대로 두고 읽히게만 바꾼다. */
.꼬리{margin-top:64px;padding-top:20px;border-top:1px solid var(--oat);
      font-size:13.5px;color:var(--deep-wool);line-height:1.65}
