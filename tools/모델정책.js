...
const 제미나이역할 = [
  ...
  { 이름: '콘텐츠 초벌 대량 생성(과제·퀴즈)', 통로: '(미배선)', 돈열쇠필요: true, 왜: '한 덩어리 생성 73.8 로 최상급에 0.3%p 차 · 마무리는 클로드' },
  { 이름: '대조·채점·분류', 통로: '(미배선)', 돈열쇠필요: true, 왜: '같은 축 — 양이 많을수록 값이 커진다' },
...
const 제미나이금지 = [
  ...
  { 무엇: '학생을 식별하는 데이터', 근거: '공짜 등급은 입력이 학습에 쓰일 수 있다 — 철학 ㉣', 대신: '식별자를 떼고 보낸다' },
];
...
module.exports = {
  ...
  열림대기, 제미나이역할, 제미나이금지,   // 세 모델 배치(09-04) — 정찰이 열림대기를 감시한다
  코덱스캐시, 코덱스캐시경로,
