...
const 열림대기 = {
  'gpt-6': {
    ...
    안쓸자리: ['넓은 웹 조사(0.7%p 차라 클로드에 남긴다 · 클로드에남긴다 표)'],
...
const 클로드에남긴다 = [
  {
    ...
    왜: '차이가 0.7%p 뿐이다(브라우징 91.5 대 클로드 90.8) — 「사실상 같다」의 전형이라 싼 쪽이 이긴다. ' +
      '게다가 아스트라는 솔보다 작업당 3배 넘게 한도를 먹으므로, 유호님이 사시는 한도를 동점인 일에 태우게 된다',
    잰것: '배치 지도 09-04 가 스스로 「근거가 가장 약하다」고 적어 뒀다',
  },
];
...
const 제미나이금지 = [
  { 무엇: '터미널·환경 조작(긴 도구 사용)', 근거: '명령창 시험 19.1 = 1등(57.7)의 3분의 1 · 같은 「코딩」의 다른 시험은 73.8 이라 성능 일반화가 안 된다', 대신: 'codex(실행자 레인) 또는 클로드' },
