 ...
 *   · tests/버전충돌.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다): 커밋 전에 "이미 쓴 번호"를 잡는다(발각 시점을 당겼을 뿐, 충돌 자체는 난다)
 ...
 * 자세한 근거 = tools/toil.js 머리말 · docs/_ops/손일장부.md(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다).
 *
...
/* ── 순수 함수 (tests/버전채번.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다)가 직접 로드해 검증) ───────────────── */
 ...
 *   `tests/버전채번.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다)` 「실저장소에 [vNEXT] 자리표가 남아 있지 않다」가 빨개지고, 그 적색은
 ...
 *
 * 🔴 그물이 있다고 믿었는데 없었다: 실저장소를 재는 자리표 검사는 `tests/버전채번.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다)` 의
