...
/* 간판(제목·소개·분류·꼬리표)은 `bots/오버레이/라디오간판.js` 한 곳이 쥔다 — 09-08 에 모았다.
   그전엔 세 곳이 따로 들고 있어서 한 곳만 고쳤을 때 갈렸다.
   🔴 자리가 `bots/` 인 까닭: **라디오 서버에는 `tools` 가 없다**(bots·docs 뿐). */
const { 방송제목, 방송소개 } = require('../bots/오버레이/라디오간판.js');
