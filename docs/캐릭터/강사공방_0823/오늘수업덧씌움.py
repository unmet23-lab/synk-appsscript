...
안여백 = 124
글좌 = 카["좌"] + 안여백
기록.append(("제목", 글(카["좌"] + 8, 카["위"] - (150 if not 전면 else 186), "오늘 수업", 60, 잉크, True)))
...
기록.append(("열기", 글(글좌, 밑줄y - 76, "출석 찍기 — 10명 중 8명", 34, 보조, False)))
...
기록.append(("출석설명", 글(출["좌"] - 34, 출["아래"] + 100, "꿰맨 단추 = 온 학생 · 빈 단추 = 아직", 28, 보조2, False)))
