...
with ZipFile(root/'SYNK-brand-introductions.zip','w',ZIP_DEFLATED,compresslevel=6) as z:
    names=['읽어주세요.md','carousel.html','SYNK-LAB-carousel.zip','자산명세.json','사용자산.json','소개서_문안.json','캐러셀_문안.json']
...
summary=[]
for filename in ['SYNK-LAB-carousel.zip','SYNK-brand-introductions.zip']:
