...
/* ══════════════════════════════════════════════════════════
 * 3층 — 벤더 중립 AI 어댑터
 * [2026-09-11 재대조] 이 저장소에서 api.anthropic.com을 직접 부르는 곳은 **8군데**다 — 상담_호출_·
 * 상담_인계초안_·상담_역번역_·callClaudeFeedback_·aiCall_·aiText_·callClaudeTalk_·두뇌_AI_anthropic_.
 ...
 * 09-11 코드상 세 자리(상담_호출_·상담_인계초안_·이 함수)에 `cache_control` 이 있고 나머지 다섯에는 없다.
