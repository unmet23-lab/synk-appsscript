...
function setupMonsters() {
  ...
  replaceContentType(ss, 'monster', [ // [v9.11] 도감 스토리 — 아기자기·1~2문장, 뇌과학 은유 유지
    ...
    ['M07','monster','싱크마스터','배움의 길을 다 걸어 온 시냅스 ✨ 그가 지나가면 반 전체가 환해져요 — 배움의 끝에서, 모든 것이 이어졌어요.','',2400]
  ]);
  calcAll();
}
 ...
 * 0개(전멸)일 때만 자동 복구된다. 씨앗은 '' — 그림 넣기는 별도 자산 트랙이다.
 * 소개 문장은 가이드_정본.md §2 성격 규격(까몽=한 낱말·몸짓, 마린=시작과 끝에만)을 그대로 딴다. */
function GUIDE_ROWS_() {
  return [
    ['G01', 'guide', '몽글', '곁에 오는 펠트 친구 🧶 말을 걸고, 웃고, 네가 맞힌 문장을 기억해요.', '', 0],
    ['G02', 'guide', '까몽', '말수가 적은 단짝 🖤 한 낱말과 몸짓으로 곁을 지켜요.', '', 0],
    ['G03', 'guide', '마린', '시작과 끝에만 나타나는 미니어처 ⚓ 조용히 너의 길을 봐 두어요.', '', 0]
  ];
}
...
const SELF_DECLARE_COLS_ = [['드림한줄', 80], ['최애', 105], ['몬스터이름', 41], ['고른가이드', 55]]; // [함께한날 막1] 가이드를 바꾼 날이 한 줄 남는다 — 교체 무제한(설계 §7-⑥ 기본값)의 이력 짝
...
const MN_CONTENTS_G = {
  ...
  "HW115": "Өнөөдөр сурсан 3 үгийн толь бичгийн жишээ өгүүлбэрээс тус бүр 1-ийг гараараа хуулж бичээд, 1-ийг нь өөрийн тухай болгон өөрчилж бичээрэй.",
  ...
  "HW124": "Өнөөдөр сурсан үгсийг нэр үг · үйл үг · тэмдэг нэрээр ангилаад, 1 үйл үгээр 1 өгүүлбэр зохиогоорой.",
  ...
  "HW209": "Сурах бичгээс өнөөдөр үзсэн дүрэм орсон 2 өгүүлбэр олж доогуур нь зураад, 1-ийг нь өөрийн тухай болгон өөрчилж бичээрэй.",
  ...
  "HW501": "Энэ долоо хоногийн үгнээс эргэлзэж буй 3 үгээ сонгож, тус бүрээр 1 өгүүлбэр зохиогоорой.",
...
const MN_SPEAK = {
  today: [
    ...
    ["Тавтай морил. Өнөөдрийн эрдэм ч чамтай хамт бол баяр наадам билээ ✨","Чамайг хүлээж байсан билээ — өнөөдөр ямар мэргэн ухаан цуглуулах бол 📜","Чамайг хаалга нээх агшинд миний өдөр ч эхэлдэг юм шүү"], // 🔴 [08-27] 👑 걷음. 이 줄 셋은 «왕정 말투 대역»이라 한국어와 함께 재번역 대기 — 새 한국어 원문 = 「왔구나. 오늘도 같이 할 생각에 아침부터 좋았어 / 기다리고 있었어 — 오늘은 뭘 배워 볼까? / 네가 문을 여는 순간, 내 하루도 시작돼」 (몽골어는 원어민 검수 전까지 안 고친다)
  ],
  miss3: [
...
const MN_HOMEWORK_CHECKPOINT = {
  ...
  "HW104": "Жишээ өгүүлбэрээ өөрөө зохиосон эсэх",
  ...
  "HW115": "Хуулсан бичиг + өөрийн 1 өгүүлбэр",
  ...
  "HW209": "Жишээ олох + өөрийн 1 өгүүлбэр",
  ...
  "HW501": "Сонгосон 3 үг + тус бүр 1 өгүүлбэр",
...
function setupHomework() {
  ...
  replaceContentType(ss, 'homework', [
    ...
    ['HW103','homework','어휘','새 단어 3개의 반대말 또는 비슷한 말을 찾아 오세요.','뜻을 내 말로 설명해 보기',103],
    ['HW104','homework','어휘','오늘 배운 단어 5개로 미니 단어장(단어+뜻+예문 1개) 만들기.','예문을 내 문장으로 만들었는지',104],
    ...
    ['HW108','homework','어휘','오늘 배운 단어 3개를 그림으로 그려 오기(뜻은 쓰지 말고).','그림만 보고 단어 말해 보기',108],
    ...
    ['HW115','homework','어휘','오늘 배운 단어 3개의 사전 예문을 한 개씩 손으로 베껴 쓰고, 그중 1개를 내 이야기로 바꿔 쓰기.','베낀 손글씨 + 내 문장 1개',115],
    ...
    ['HW124','homework','어휘','오늘 배운 단어를 명사·동사·형용사로 나누고, 동사 1개로 문장 1개 만들기.','품사 나누기 + 동사 문장 1개',124],
    ['HW125','homework','어휘','오늘 배운 단어 3개로 두 줄 대화 만들기.','대화 자연스러움',125],
    ['HW126','homework','어휘','모르는 단어 1개 뜻을 먼저 추측해 쓰고 사전 확인.','어떻게 추측했는지 말해 보기',126],
    ...
    ['HW209','homework','문법·문장','교재에서 오늘 배운 문법이 든 문장 2개 찾아 밑줄 — 1개를 내 이야기로 바꿔 쓰기.','용례 찾기 + 내 문장 1개',209],
    ...
    ['HW501','homework','복습','이번 주 단어 중 헷갈리는 3개 골라 각 1문장.','고른 단어 3개 + 각 1문장',501],
...
function setupOnboarding() {
  ...
  const rows = [
    ['student', 'SYNK에 온 걸 환영해! 🎮', '출석하고 미션을 하면 네 캐릭터가 진화해. 도전·성장 기록과 포인트를 모아 도감을 채우고, 한국어도 쑥쑥 자라!', 'Ирцээ бүртгүүлж даалгавраа хийвэл таны хамтрагч хувьсана. Сорилт, өсөлтийн тэмдэглэл ба оноо цуглуулж цомгоо дүүргэ, солонгос хэл ч өснө!', '🐣'],
