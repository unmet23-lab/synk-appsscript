...
const MN_CONTENTS_G = {
  ...
  "HW115": "Толь бичгийн 3 жишээ өгүүлбэрийг гараараа хуулж бичээд, 1-ийг нь өөрийн тухай болгон өөрчилж бичээрэй.",
  "HW116": "Өнөөдөр сурсан 3 үгийг чанга дуугаар 3 удаа уншаад, хамгийн сайн хэлсэн үгэндээ од тавиарай.",
  ...
  "HW207": "Өнөөдөр үзсэн 2 өгүүлбэрээс 조사(нөхцөл)-г олж дугуйлаад, 1-ээр нь шинэ өгүүлбэр зохиогоорой.",
  ...
  "HW410": "Энэ улирлын төгсгөлийн өдрийн өөртөө зориулж 2 өгүүлбэр бичээрэй.",
  ...
  "HW506": "Энэ долоо хоногт эргэлзсэн 1 зүйлээ «Маргаашийн нууц мэх» тэмдэглэл болгоорой (яагаад эргэлзсэн + зөв өгүүлбэр).",
...
const MN_HOMEWORK_CHECKPOINT = {
  ...
  "HW108": "Зургаа хараад үгээ хэлж үзэх",
  ...
  "HW321": "5 дахь удаад хэр зөөлөн болсон бэ",
  ...
  "HW501": "Өөрөө олж мэдсэн нь аль хэдийн чадвар",
  ...
  "HW702": "-고 싶다",
  "HW703": "Үнэнчээр тэмдэглэхэд л хангалттай",
  "HW704": "Сурах орчин",
...
function setupHomework() {
  ...
  replaceContentType(ss, 'homework', [
    ...
    ['HW109','homework','어휘','제일 어려운 단어 1개를 10번 소리 내어 읽기 — 몇 번째부터 편해지는지 체크.','그 단어 발음 확인',109],
    ...
    ['HW115','homework','어휘','사전 예문 3개를 손으로 베껴 쓰고, 그중 1개를 내 이야기로 바꿔 쓰기.','베낀 손글씨 + 내 문장 1개',115],
    ['HW116','homework','어휘','오늘 배운 단어 3개를 큰 소리로 3번씩 읽고, 제일 자신 있는 단어에 별표.','발음 확인',116],
    ...
    ['HW207','homework','문법·문장','오늘 배운 문장 2개에서 조사를 찾아 동그라미 — 그중 1개로 새 문장 1개.','조사 찾기 + 새 문장 1개',207],
    ...
    ['HW321','homework','말하기','발음이 꼬이는 문장 1개를 5번 반복.','다섯 번째에 얼마나 부드러워졌는지',321],
    ...
    ['HW410','homework','쓰기','이번 시즌이 끝나는 날의 나에게 보내는 2문장.','미래 표현',410],
    ...
    ['HW501','homework','복습','이번 주 단어 중 헷갈리는 3개 골라 각 1문장.','스스로 찾은 것부터가 실력',501],
    ...
    ['HW506','homework','복습','이번 주 헷갈렸던 것 1개를 내일의 필살기 노트로 — 왜 헷갈렸는지 + 바른 문장.','원인 분석',506],
    ...
    ['HW703','homework','리셋','지난주 단어장 소리 내어 1번 통독(체크만).','정직한 셀프 체크면 충분',703],
    ...
    ['HW723','homework','리셋','단어장 표지에 내 이름과 목표 한 단어를 한국어로 쓰고 꾸미기.','애착 형성',723],
