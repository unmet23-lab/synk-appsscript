...
function setupOnboarding() {
  ...
  const rows = [
    ['student', 'SYNK에 온 걸 환영해! 🎮', '출석하고 미션을 하면 네 캐릭터가 진화해. 도전·성장 기록과 포인트를 모아 도감을 채우고, 한국어도 쑥쑥 자라!', 'Ирцээ бүртгүүлж даалгавраа хийвэл таны монстр хувьсана. Титэм ба оноо цуглуулж цомгоо дүүргэ, солонгос хэл ч өснө!', '🐣'],
...
function syncToNotion_() {
  ...
  rows.forEach(r => {
    ...
    const properties = {
      ...
      '총포인트': { number: points }, '도전성장수': { number: crowns }, '최장연속출석': { number: bestStreak },
