 ...
 *     ⚠ 1년 과정의 파생 성질: 떠나는 창이 3년 과정보다 **훨씬 좁다**. 다만 «전원 동시»는 아니다 —
 *     **승급은 도달제**라 8주 평가 미달이면 재회전한다(집필 규범 §승급 · 이종 검수 08-25 이 잡은 과장).
 *     🔑 그리고 **이 파일은 졸업 여부를 안 본다** — `궤적수확_면접_` 은 학생ID 가 붙은 면접폼이면
 *     **재학 중에도** 그날 바로 outcome_log 에 앉힌다(재학 중 대학 지원이 그 경우). 그러니 「졸업 전엔
 *     빈 그릇」은 틀린 말이고, 갈라 읽어야 한다: **관측**은 첫 학기부터 · **졸업 성과**가 2028-02 부터다.
 *
 ...
 *   않지만 조용히 뭉개진다. 회귀 tests/궤적.test.js(⚠삭제됨 e75fc7fc 2026-08-19 — 지금 없다) 가 두 목록의 정합을 검사했다 — 그것이 걷혀, 지금은 그쪽 선택지를 늘리는 손이 여기도 같이 본다. */
