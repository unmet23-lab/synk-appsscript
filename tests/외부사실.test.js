...
const 외부사실 = [
  /* Meta–Manus 인수 해제 = **등재 해제**(2026-08-09). Manus 를 스택에서 통째로 지우면서
   * 이 사실에 매달린 판정(커넥터 의존)이 같이 사라졌다. 잠금을 남겨두면 정본 조각
   * (2026-04-27·2026-06-11)을 지키려고 가이드가 Manus 문단을 계속 들고 있어야 한다 —
   * 유호님이 지우라고 한 것을 회귀가 되살리는 꼴이다. 되살릴 조건 = Manus 재제안 해제. */
  {
    이름: 'Sora 종료(2단계)',
    // 「2026-04 종료」는 앱과 API 를 한 날짜로 뭉갠 요약이다.
    // Sora 근처의 2026-04 만 본다(다른 곳의 2026-04-NN 을 무조건 잡으면 오탐).
    낡은표기: /Sora[^\n]{0,30}2026-04(?!-)/,
