 ...
 *
 * 🔴 **이 파일이 왜 뒤늦게 섰나** (2026-08-17 · 반입 사연): 수리는 master 에 `5c270fc2` 로 들어갔는데
 *   그것을 지키는 회귀는 워크트리 가지에 **갇힌 채** 남았다 — F403 이 신고한 바로 그 모양이다.
 *   실측: 반입 직전 `tests/트랙경계.test.js` 42건은 전건 초록이었고, 그 초록은 F529 를 안 재고 있었다.
 *
