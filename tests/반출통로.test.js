...
const 나가는자리_ = [
  ...
  { file: '상담AI.js',        vendor: 'InstagramGraph', n: 2, 뭐: '인스타 사용자 팔로우 조회(사용자 ID·IG 전용 토큰) · Instagram Login 장기 토큰 갱신(토큰만, 학생 원문 0)' },
...
/* ── ①-나 「N군데」라 적은 주석을 실제 호출 수와 대조한다 ──────────────
 * 2026-09-11 엔진_두뇌.js의 누락된 상담 인계 초안을 포함해 8곳으로 정정했다.
 * 수리된 어긋남은 예외 목록에서 제거한다. 새로 어긋난 주석은 그대로 실패한다. */
const 알려진_어긋난_셈_ = [];
