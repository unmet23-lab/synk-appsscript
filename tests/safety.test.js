...
test('[vNEXT] teacher_stats 22열 — 정본 §7 앱자동 5지표가 축 위에 얹혔고, 미측정 행은 빈칸이다', () => {
  ...
  /* [vNEXT] 등급판정 — 전부 미측정이면 **등급을 지어내지 않는다.** 재등록이 안 재지면 첫 시즌으로 읽혀
...
test('[v9.113] 인센티브 배점 3종 — 구간 경계 + 미측정은 점수 자체가 없다', () => {
  ...
  // [vNEXT] 숙제 제출률 10점 · 근태 10점 — 정본 §7 이 「앱 자동」으로 잡은 나머지 둘
  ...
  /* [vNEXT] 개원 첫 시즌 표 — 재등록 30점이 사라지고 그 30점이 나머지로 옮겨 간다(정본 §7 첫 시즌 표).
...
test('[vNEXT] 등급 판정 — 재정규화·미측정 스킵·필수 관문 3개 (급여 정본 §7)', () => {
