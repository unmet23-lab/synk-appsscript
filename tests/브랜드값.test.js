...
const 퇴역 = [ // 무채축(0039209e)으로 걷힌 네이비·크림 — 값 자리 실측 0건에서 출발(08-20 선별)
  ...
  // 🆕 2026-09-08 — 실땀(Stitch)이 4K 정본 실측값으로 갈렸다(유호 확정 「4K 가 정본이야」).
  //   옛 크림빛 값이 값 자리에 되살아나면 화면의 실땀이 두 색으로 갈린다.
  //   🔴 여기 적힌 것은 «옛 값»이다 — 일괄 치환 도구가 이 줄까지 갈아 버리면 새 값이
  //   퇴역으로 잡혀 저장소 전체가 빨개진다(09-08 에 한 번 밟았다).
  '#F0E3C8',
];
