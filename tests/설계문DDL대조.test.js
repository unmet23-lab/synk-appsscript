 ...
 *   이 자의 앞판(`tests/설계문값대조.test.js`)이 08-19 대청소(e75fc7fc)로 **한 번** 걷혔고,
 *   그 사이 설계문 §3-5-b 의 DDL 사본이 실물과 «실제로» 갈렸다(09-02 실측 — 표 열 둘 · freeze 허용 칸 둘).
 *   ⚠ 그 앞판은 **0177dc5a(08-22)에 되살아나 지금 있다** — 이 줄을 「지금도 없다」로 읽지 말 것.
 *   갈림이 난 것은 «비어 있던 그 사흘»이고, 이 파일은 그 구멍을 막는 둘째 기계로 남는다.
