...
process.stdin.on('end', () => {
  ...
  if (되물음) {
    ...
    /* 🔴 [09-09] «0개»를 그냥 찍지 않는다 — 그 줄이 「깨끗하다」로 읽혔다.
     *   이 자는 층이 셋인데 ①로마자 ③한자만 «내가 답을 낸 뒤 바로» 본다. 한글로 적힌
     *   전문어(상호·등기·정관·액면가·조사보고자 …)는 ②되물음이 잡는데, 그건 유호님이
     *   이미 되물으신 «뒤»다. 그러니 「0개」는 «깨끗하다»가 아니라 «내가 볼 수 있는
     *   갈래에서 0개»다 — [[zero-is-a-success-face-taxonomy]] 그 무늬라 문장으로 막는다.
     *   09-08 실측: 「상호」가 아는말 목록에 없는데도 이 훅은 「낯선 것 0개」를 냈고,
     *   같은 답에 등기·정관·발기설립·액면가·무보수 대표가 함께 들어 있었다. */
    줄.push('📝 **로마자·한자에서는 0개다.** 🔴 한글로 적힌 전문어(상호·등기·정관 …)는 **이 자가 원리상 못 본다** — 그 갈래는 내가 앞에서 막는다.');
    줄.push('→ 낱말이 통째로 낯선 밭(법률·회계·등기·세무)이면 절 머리에 **낱말 풀이를 먼저 깔고** 들어간다.');
  }
