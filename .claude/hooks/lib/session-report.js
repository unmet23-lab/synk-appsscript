...
function boardTrack(cwd, commits, sid) {
  /* 🔴 **파일이 주인을 밝히면 그 말이 최종이다** (2026-08-12 실사고 F337 · 사연 = board-id.파일지문).
   ...
   *   그 줄이 내 지문·내 해시를 아무리 인용해도 이제 나를 가리키지 않는다(F337). */
 ...
 *
 * 🔑 재료가 하나 늘었다 — **보드 파일 이름**(F337). `boardTrack` 이 이제 파일 소유로 먼저
...
const 새트랙 =
  ...
  '집을 땐 남의 줄을 고치지 말고 **내 파일에 내 줄**을 새로 선언한다.';
